...
function xHistogram(array, options = {}) {
    ...
    const { centerX = true, nbSlots = typeof histogram === 'undefined' ? 256 : histogram.x.length, logBaseX, logBaseY, absolute = false, } = options;
    if (absolute) {
    ...
    const x = typeof histogram === 'undefined'
