 ...
 */
export declare function xDivide<ArrayType extends NumberArray = Float64Array>(array1: NumberArray, array2: NumberArray | number, options?: XDivideOptions<ArrayType>): ArrayType;
//# sourceMappingURL=xDivide.d.ts.map